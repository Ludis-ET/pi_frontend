...
export const Login = () => {
  return (
    <div className="w-full h-full m-0 p-0 absolute overflow-hidden flex flex-wrap gap-12 bg-white text-black">
      ...
      <div className="absolute bg-purple-500 w-[600px] h-[600px] rounded-[100%] left-[-10%] top-[-20%]"></div>
      <div className="absolute flex flex-wrap justify-center md:right-[15%] md:top-[15%] z-10">
        <div className="absolute bg-purple-500 w-[600px] h-[600px] rounded-[100%] right-[-80%] top-[-50%]"></div>
        <div className="absolute bg-purple-500 w-[600px] h-[600px] rounded-[100%] left-[-80%] bottom-[-50%]"></div>
