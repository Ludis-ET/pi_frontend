                ...
                <div className="sidebar hidden lg:flex w-1/3 flex-2 flex-col pr-6">
                  ...
                  <div className="flex-1 h-full overflow-auto px-2">
                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                      ...
                      <div className="flex-1 px-2">
                        <div className="truncate w-32">
                          <span className=" -800">Ryann Remo</span>
                        </div>
                        <div>
                          <small className=" -600">Yea, Sure!</small>
                        </div>
                      </div>
                    ...
                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                      ...
                      <div className="flex-1 px-2">
                        <div className="truncate w-32">
                          <span className=" -800">Karp Bonolo</span>
                        </div>
                        <div>
                          <small className=" -600">Yea, Sure!</small>
                        </div>
                    ...
                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md border-l-4 border-purple-500">
                      <div className="flex-2">
                        <div className="w-12 h-12 relative">
                          <img
                            className="w-12 h-12 rounded-full mx-auto"
                      ...
                      <div className="flex-1 px-2">
                        <div className="truncate w-32">
                          <span className=" -800">Mercedes Yemelyan</span>
                        </div>
                        <div>
                          <small className=" -600">Yea, Sure!</small>
                        </div>
                    ...
                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                      ...
                      <div className="flex-1 px-2">
                        <div className="truncate w-32">
                          <span className=" -800">Cadi Kajetán</span>
                        </div>
                        <div>
                          <small className=" -600">Yea, Sure!</small>
                        </div>
                    ...
                    <div className="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md">
                      ...
                      <div className="flex-1 px-2">
                        <div className="truncate w-32">
                          <span className=" -800">Rina Samuel</span>
                        </div>
                        <div>
                          <small className=" -600">Yea, Sure!</small>
                        </div>
